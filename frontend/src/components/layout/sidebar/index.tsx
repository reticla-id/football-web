...
export function Sidebar({
  ...
  const sidebarContent = (
    <aside
      className={`flex h-full flex-col border-r border-zinc-800/80 bg-[linear-gradient(180deg,rgba(17,17,17,0.96),rgba(8,8,8,0.98))] shadow-[24px_0_60px_rgba(0,0,0,0.22)] transition-all duration-300 ${
